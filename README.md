...
3. The application will automatically initialize the database on first load
4. Grant camera permissions when prompted for QR code scanning
...
2. **Enable GitHub Pages**
   ...
   - Under **Source**, select **main** branch (or **master** if that's your default branch)
   - Select **/ (root)** folder
   - Click **Save**
...
- **Database**: sql.js (SQLite in the browser via CDN)
